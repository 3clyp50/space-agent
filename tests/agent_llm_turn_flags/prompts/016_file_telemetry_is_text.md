...
- after fileRead-style success telemetry, result↓ text is the file text for the immediate next edit unless telemetry says partial truncated or stale
...
- do not re-read a file when the latest telemetry already contains that file's exact text
