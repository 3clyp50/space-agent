import { createStore } from "/fw/AlpineStore.js";
import { initializeRuntime } from "/runtime.js";
import { buildPromptMessages, streamChatCompletion } from "/chat/api.js";
import {
...
import { parseLlmParamsText } from "/chat/llm-params.js";

const runtime = initializeRuntime({
  proxyPath: "/api/proxy"
});

if (!runtime.currentChat || typeof runtime.currentChat !== "object") {
  runtime.currentChat = {
    messages: []
  };
}

runtime.currentChat.attachments = createAttachmentRuntime();

if (!Array.isArray(runtime.currentChat.messages)) {
  runtime.currentChat.messages = [];
}
